...
public class MstJenisTanamanSchema {
    public static final String TABLE_NAME = "MST_JENIS_TANAMAN";
    public static final String _ID = "ID";
    public static final String JENIS_TANAMAN_ID = "JENIS_TANAMAN_ID";
    public static final String JENIS_TANAMAN_NAME = "JENIS_TANAMAN_NAME";
    ...
    public static final String SQL_CREATE_ENTRIES = "CREATE TABLE " +
            ...
            "" + JENIS_TANAMAN_ID + " " + Type.VARCHAR_NULLABLE_100 + ", " +
            "" + JENIS_TANAMAN_NAME + " " + Type.VARCHAR_NULLABLE_100 + ", " +
