...
//    private static final String address = "http://10.0.8.51:9393/";
    ...
    public static final String URL_FOR_POST_PENGUKURAN_POHON_V1 = address + "api/v1/postPengukuranPohon";
            ...
            public void run() {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        values.put(TrnTallySheet.KH_AWAL, json_projek.getString("kelashutan_awaljangka"));
                        values.put(TrnTallySheet.KH_AWAL_NAME, json_projek.getString("kelashutan_awaljangka_name"));
                        values.put(TrnTallySheet.JENIS_TANAMAN_POKOK, json_projek.getString("tanaman_pokok"));
                        values.put(TrnTallySheet.JENIS_TANAMAN_POKOK_NAME, json_projek.getString("tanaman_pokok_name"));
                        values.put(TrnTallySheet.JENIS_TANAMAN_PENCAMPUR, json_projek.getString("tanaman_pencampur"));
                        values.put(TrnTallySheet.JENIS_TANAMAN_PENCAMPUR_NAME, json_projek.getString("tanaman_pencampur_name"));
                        values.put(TrnTallySheet.JARAK_TANAM, json_projek.getString("jarak_tanam"));
                        values.put(TrnTallySheet.JENIS_TANAMAN_SELA, json_projek.getString("tanaman_sela"));
                        values.put(TrnTallySheet.JENIS_TANAMAN_SELA_NAME, json_projek.getString("tanaman_sela_name"));
                        values.put(TrnTallySheet.PERTUMBUHAN_TEGAKAN, json_projek.getString("pertumbuhan_tegakan"));
                        values.put(TrnTallySheet.PERTUMBUHAN_TEGAKAN_NAME, json_projek.getString("pertumbuhuan_tegakan_name"));
                        values.put(TrnTallySheet.KERATAAN_TEGAKAN, json_projek.getString("kerataan_tegakan"));
                        values.put(TrnTallySheet.KERATAAN_TEGAKAN_NAME, json_projek.getString("kerataan_tegakan_name"));
                        values.put(TrnTallySheet.KEMURNIAN_TEGAKAN, json_projek.getString("kemurnian_tegakan"));
                        values.put(TrnTallySheet.KEMURNIAN_TEGAKAN_NAME, json_projek.getString("kemurnian_tegakan_name"));
                        values.put(TrnTallySheet.JENIS_PENCAMPUR_KEMURNIAN, json_projek.getString("kemurnian_tegakan_jns_pencampur"));
                        values.put(TrnTallySheet.JML_PHN_KEMURNIAN, json_projek.getString("kemurnian_tegakan_jml_pohon"));
                        values.put(TrnTallySheet.DIAMETER_KEMURNIAN, json_projek.getString("kemurnian_tegakan_diameter"));
                        values.put(TrnTallySheet.KETERANGAN_KEMURNIAN, json_projek.getString("kemurnian_tegakan_keterangan"));
                        values.put(TrnTallySheet.BENTUK_LAPANGAN, json_projek.getString("bentuk_lapangan"));
                        values.put(TrnTallySheet.BENTUK_LAPANGAN_NAME, json_projek.getString("bentuk_lapangan_name"));
                        values.put(TrnTallySheet.KEMIRINGAN_LAPANGAN, json_projek.getString("kemiringan_lapangan"));
                        values.put(TrnTallySheet.KEMIRINGAN_LAPANGAN_NAME, json_projek.getString("kemiringan_lapangan_name"));
                        values.put(TrnTallySheet.ARAH_LERENG, json_projek.getString("arah_lereng"));
                        values.put(TrnTallySheet.ARAH_LERENG_NAME, json_projek.getString("arah_lereng_name"));
                        values.put(TrnTallySheet.JENIS_TANAH, json_projek.getString("jenis_tanah"));
                        values.put(TrnTallySheet.JENIS_TANAH_NAME, json_projek.getString("jenis_tanah_name"));
                        values.put(TrnTallySheet.WARNA_TANAH, json_projek.getString("warna_tanah"));
                        values.put(TrnTallySheet.WARNA_TANAH_NAME, json_projek.getString("warna_tanah_name"));
                        values.put(TrnTallySheet.KEDALAMAN_TANAH, json_projek.getString("kedalaman_tanah"));
                        values.put(TrnTallySheet.KEDALAMAN_TANAH_NAME, json_projek.getString("kedalaman_tanah_name"));
                        values.put(TrnTallySheet.KESARANGAN_TANAH, json_projek.getString("kesarangan_tanah"));
                        values.put(TrnTallySheet.KESARANGAN_TANAH_NAME, json_projek.getString("kesarangan_tanah_name"));
                        values.put(TrnTallySheet.KEMANTAPAN_TANAH, json_projek.getString("kemantapan_tanah"));
                        values.put(TrnTallySheet.KEMANTAPAN_TANAH_NAME, json_projek.getString("kemantapan_tanah_name"));
                        values.put(TrnTallySheet.BATUAN_TANAH, json_projek.getString("batuan"));
                        values.put(TrnTallySheet.BATUAN_TANAH_NAME, json_projek.getString("batuan_name"));
                        values.put(TrnTallySheet.KANDUNGAN_HUMUS, json_projek.getString("humus"));
                        values.put(TrnTallySheet.KANDUNGAN_HUMUS_NAME, json_projek.getString("humus_name"));
                        values.put(TrnTallySheet.KEMASAMAN, json_projek.getString("kemasaman"));
                        values.put(TrnTallySheet.KEMASAMAN_NAME, json_projek.getString("kemasaman_name"));
                        values.put(TrnTallySheet.TINGKAT_EROSI, json_projek.getString("tingkat_erosi"));
                        values.put(TrnTallySheet.TINGKAT_EROSI_NAME, json_projek.getString("tingkat_erosi_name"));
                        values.put(TrnTallySheet.TUMBUHAN_BWH_JENIS, json_projek.getString("tumbuhan_bwh"));
