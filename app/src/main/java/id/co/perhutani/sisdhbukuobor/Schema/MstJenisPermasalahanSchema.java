...
public class MstJenisPermasalahanSchema {
    public static final String TABLE_NAME = "MST_JENIS_PERMASALAHAN";
    public static final String _ID = "ID";
    public static final String JENIS_PERMASALAHAN_ID = "JENIS_PERMASALAHAN_ID";
    public static final String JENIS_PERMASALAHAN_NAME = "JENIS_PERMASALAHAN_NAME";
    ...
    public static final String SQL_CREATE_ENTRIES = "CREATE TABLE " +
            ...
            "" + JENIS_PERMASALAHAN_ID + " " + Type.VARCHAR_NULLABLE_100 + ", " +
            "" + JENIS_PERMASALAHAN_NAME + " " + Type.VARCHAR_NULLABLE_100 + ", " +
