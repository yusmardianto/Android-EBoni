...
public class MstStatusInteraksiSchema {
    public static final String TABLE_NAME = "MST_STATUS";
    public static final String _ID = "ID";
    public static final String ID_STATUS = "ID_STATUS";
    public static final String NAMA_STATUS = "NAMA_STATUS";
    ...
    public static final String SQL_CREATE_ENTRIES = "CREATE TABLE " +
            ...
            "" + ID_STATUS + " " + Type.VARCHAR_NULLABLE_100 + ", " +
            "" + NAMA_STATUS + " " + Type.VARCHAR_NULLABLE_100 + ", " +
