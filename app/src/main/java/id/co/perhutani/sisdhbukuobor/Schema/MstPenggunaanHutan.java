...
public class MstPenggunaanHutan {

    public static final String TABLE_NAME = "MST_PENGGUNAAN_HUTAN";
    public static final String _ID = "ID";
    public static final String PENGGUNAAN_HUTAN_ID = "PENGGUNAAN_HUTAN_ID";
    ...
    public static final String SQL_CREATE_ENTRIES = "CREATE TABLE " +
            ...
            "" + PENGGUNAAN_HUTAN_ID + " " + Type.VARCHAR_NULLABLE_100 + ", " +
