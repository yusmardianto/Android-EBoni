...
public class TrnOverSpin {

    public static final String TABLE_NAME = "TRN_OVER_SPIN";
    public static final String _ID = "ID";
    public static final String TANGGAL = "TANGGAL";
    public static final String ANAK_PETAK = "ANAK_PETAK";
    public static final String JENIS_BIBIT = "JENIS_BIBIT";
    ...
    public static final String SQL_CREATE_ENTRIES = "CREATE TABLE " +
            ...
            "" + JENIS_BIBIT + " " + Type.VARCHAR_NULLABLE_100 + ", " +
            "" + KONDISI + " " + Type.VARCHAR_NULLABLE_100 + ", " +
            "" + JUMLAH + " " + Type.VARCHAR_NULLABLE_100 + ", " +
