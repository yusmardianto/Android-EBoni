...
public class MstDesaSchema {
    public static final String TABLE_NAME = "MST_DESA";
    public static final String _ID = "ID";
    public static final String ID_DESA = "ID_DESA";
    public static final String KODE_DESA = "KODE_DESA";
    public static final String KECAMATAN_ID = "KECAMATAN_ID";
    ...
    public static final String SQL_CREATE_ENTRIES = "CREATE TABLE " +
            ...
            "" + ID_DESA + " " + Type.VARCHAR_NULLABLE_100 + ", " +
            "" + KODE_DESA + " " + Type.VARCHAR_NULLABLE_100 + ", " +
            "" + KECAMATAN_ID + " " + Type.VARCHAR_NULLABLE_100 + ", " +
