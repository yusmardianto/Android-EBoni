...
public class MstStrataSchema {

    public static final String TABLE_NAME = "MST_STRATA";
    public static final String _ID = "ID";
    public static final String STRATA_ID = "STRATA_ID";
    public static final String STRATA_NAME = "STRATA_NAME";
    ...
    public static final String SQL_CREATE_ENTRIES = "CREATE TABLE " +
            ...
            "" + STRATA_ID + " " + Type.VARCHAR_NULLABLE_100 + ", " +
            "" + STRATA_NAME + " " + Type.VARCHAR_NULLABLE_100 + ", " +
