...
public class MstPihakTerlibatSchema {

    public static final String TABLE_NAME = "MST_PIHAK_TERLIBAT";
    public static final String _ID = "ID";
    public static final String PIHAK_TERLIBAT_ID = "PIHAK_TERLIBAT_ID";
    public static final String PIHAK_TERLIBAT_NAME = "PIHAK_TERLIBAT_NAME";
    ...
    public static final String SQL_CREATE_ENTRIES = "CREATE TABLE " +
            ...
            "" + PIHAK_TERLIBAT_ID + " " + Type.VARCHAR_NULLABLE_100 + ", " +
            "" + PIHAK_TERLIBAT_NAME + " " + Type.VARCHAR_NULLABLE_100 + ", " +
