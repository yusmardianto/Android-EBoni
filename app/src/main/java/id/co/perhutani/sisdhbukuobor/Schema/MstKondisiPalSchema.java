...
public class MstKondisiPalSchema {

    public static final String TABLE_NAME = "MST_KONDISI_PAL";
    public static final String _ID = "ID";
    public static final String KONDISI_PAL_ID = "KONDISI_PAL_ID";
    public static final String KONDISI_PAL_NAME = "KONDISI_PAL_NAME";
    ...
    public static final String SQL_CREATE_ENTRIES = "CREATE TABLE " +
            ...
            "" + KONDISI_PAL_ID + " " + Type.VARCHAR_NULLABLE_100 + ", " +
            "" + KONDISI_PAL_NAME + " " + Type.VARCHAR_NULLABLE_100 + ", " +
