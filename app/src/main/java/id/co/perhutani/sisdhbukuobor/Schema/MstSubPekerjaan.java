...
public class MstSubPekerjaan {
    public static final String TABLE_NAME = "MST_SUB_KEGIATAN";
    public static final String _ID = "ID";
    public static final String SUB_PEKERJAAN_ID = "SUB_PEKERJAAN_ID";
    public static final String SUB_PEKERJAAN_NAME = "SUB_PEKERJAAN_NAME";
    ...
    public static final String SQL_CREATE_ENTRIES = "CREATE TABLE " +
            ...
            "" + SUB_PEKERJAAN_ID + " " + Type.VARCHAR_NULLABLE_100 + ", " +
            "" + SUB_PEKERJAAN_NAME + " " + Type.VARCHAR_NULLABLE_100 + ", " +
